...
import Vue.TextInterface;
import Vue.ChoixRoleCLI;
import Vue.ChoixRoleGUI;
import Vue.NouveauJoueurCLI;
...
public class Partie extends Observable {
	...
	private void distributionCartes() {
		...
		Carte Inquisition = new Carte("The Inquisition", witchInquisition, huntInquisition,
				"./src/images/the_inquisition.png");
		...
		Carte Wart = new Carte("Wart", witchBroomstickWart, huntBroomstickWart, "./src/images/wart.png");
		cartes.add(Wart);// 6
